...
public class CRUD {
    ...
    public static List<Player> listarPlayers() {
        ...
        try {
            // se abre una nueva sesión de Hibernate
            session = HibernateUtil.getSessionFactory().openSession();
            // se crea una query HQL para obtener todos los Players (tipada)
    ...
    public static List<Player> listarPlayersPorNick(String nick) {
        ...
        try {
            // se abre una nueva sesión de Hibernate
            session = HibernateUtil.getSessionFactory().openSession();
            // se crea una query HQL con filtro LIKE (tipada)
    ...
    public static List<Game> listarGame() {
        ...
        try {
            // se abre una nueva sesión de Hibernate
            session = HibernateUtil.getSessionFactory().openSession();
            // se crea una query HQL para obtener todos los Game (tipada)
    ...
    public static List<Compras> listarCompras() {
        ...
        try {
            // se abre una nueva sesión de Hibernate
            session = HibernateUtil.getSessionFactory().openSession();
            // se crea una query HQL para obtener todas las Compras (tipada)
    ...
    public static int eliminarTodosRegistros(String nombreTabla) {
        ...
        try {
            ...
            // usar createMutationQuery para operaciones de mutacion (no deprecado)
            registrosEliminados = session.createMutationQuery(hql).executeUpdate();
